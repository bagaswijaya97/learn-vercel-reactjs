      ...
      >
        <li className="dropdown">
          ...
          <ul className="dropdown-menu">
            <li>
              <Link to="/">Business Consultant</Link>
            </li>
            <li>
              <Link to="/home-2">It Solutions</Link>
            </li>
            <li>
              <Link to="/home-3">Creative Agency</Link>
            </li>
            <li>
              <Link to="/home-4">Transport &; Logistics</Link>
            </li>
            <li>
              <Link to="/home-5">Financial Advisor</Link>
            </li>
          </ul>
        </li>
        <li className="dropdown">
        ...
        <li className="dropdown">
          ...
          <ul className="dropdown-menu">
            ...
            <li>
              <Link to="/project-2">Project style two</Link>
            </li>
            <li>
              <Link to="/project-3">Project style three</Link>
            </li>
            <li>
        ...
        <li className="dropdown">
          ...
          <ul className="dropdown-menu">
            <li>
              <Link to="/services">Services Version One</Link>
            </li>
            <li>
              <Link to="/services-2">Services Version Two</Link>
            </li>
            <li>
              <Link to="/services-3">Services Version Three</Link>
            </li>
            <li>
              <Link to="/services-details/1">Services Details</Link>
            </li>
          </ul>
        </li>
        <li className="dropdown">
